        ...
        if name.strip() == "":
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    st.markdown(f"🎥 [Watch Career Video]({video_link})")
                ...
                st.error("⚠️ Backend server not running. Please start the FastAPI server.")
...
# ---------------------- TAB 5 ----------------------
with tabs[4]:
    st.header(f"{icons['chat']} CareerBot – Ask Your Questions")
